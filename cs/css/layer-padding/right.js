...
cs.extend.addAutocompletion({
    ...
    onSelect : function(completionObject) {
        ...
        getSingleLayerLine = function() {
            ...
            layer = layers[0];
            padding = imageTools.activeImage.width - layer.getRight();
        ...
        getDoubleLayerLine = function() {
            ...
            setMargin = function() {
                if (leftLayer.getRight() < rightLayer.getLeft()) {
                    ...
                    padding = rightLayer.getRight() - leftLayer.getRight();
                } else {
                    padding = leftLayer.getRight() - rightLayer.getRight();
                }
            };
